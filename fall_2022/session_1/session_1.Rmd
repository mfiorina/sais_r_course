...
- Download the template scripts and data for this course at **[this link](https://www.dropbox.com/sh/c4ep84ztz1rhi6f/AACKR9yFBjZhzwb375behONja?dl=0)**. NOTE -- Download the whole folder, and put it in a location that is easy to find again You will need to refer to the folder's file path in your scripts.

- Ensure that you have R and RStudio installed. If not, please follow the instructions in the **[syllabus](https://mfiorina.github.io/sais_r_course/fall_2022/syllabus/r_course_syllabus.html)**.

- Open the following file: `SAIS R Course/code/session_1_template.R`.

- Try running lines 46-48 by selecting them and clicking on "Run" (or Ctrl+Enter on Windows, Cmd+Enter on Mac). If your console shows errors, call me over and I will try to solve the issue with you.
...
Syllabus: **https://mfiorina.github.io/sais_r_course/fall_2022/syllabus/r_course_syllabus.html**
