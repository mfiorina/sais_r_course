---
title: "R Professional Skills Course — Session 1"
subtitle: "Session 1"
...
<img style="border:1px solid black;" src="pics/script1.png" width="100%"/>
...
<img style="border:1px solid black;" src="pics/script2.png" width="100%"/>
...
<img style="border:1px solid black;" src="pics/script3.png" width="100%"/>
...
2— Set up your data project folder. Make sure that it has the following components:
  - data
      - raw
      - intermediate
  - code
...
4— Open RStudio and click on "New Project" and then "Existing Directory" in the "File" dropdown menu. Navigate to your data folder and select it.
